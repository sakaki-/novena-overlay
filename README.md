...
* **[sys-apps/irqbalance-novena](https://github.com/sakaki-/novena-overlay/tree/master/sys-apps/irqbalance-novena)** ([upstream (xobs)](https://github.com/xobs/irqbalanced))
